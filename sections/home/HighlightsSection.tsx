...
const items = [
  ...
  },
  {
    ...
    paragraphs: [
      "The soundtrack on the first Bagged & Tagged film caught people off guard. It's not your typical Skynyrd-and-cliché music -  it hits harder than a crack in the nuts. It's dark, gritty, and untamed. It made riders feel like kings of the road, not just fans of the film.",
        ...
        <div className="grid gap-10 sm:grid-cols-3">
          {items.map(({ title, image, paragraphs }) => (
            <div key={title} className="flex flex-col">
              <div className="relative aspect-[4/3] overflow-hidden rounded-sm border-2 border-orange-bright">
                <Image
                  src={image}
                  alt={title}
                  fill
              ...
              <p className="mt-3 text-center font-display uppercase tracking-wide text-sm text-orange-bright">
                {title}
              </p>
